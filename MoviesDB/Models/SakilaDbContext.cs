...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=BORISS-LT\\SQLEXPRESS;Initial Catalog=SakilaDB;Integrated Security=True;Trust Server Certificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Actor>(entity =>
        {
            entity.HasKey(e => e.ActorId).HasName("PK__actor__8B2447B45E4F1F2C");
        ...
        {
            entity.HasKey(e => e.AddressId).HasName("PK__address__CAA247C8597DC744");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__category__D54EE9B4C7963C4E");
        ...
        {
            entity.HasKey(e => e.CityId).HasName("PK__city__031491A89C1AAA91");
        ...
        {
            entity.HasKey(e => e.CountryId).HasName("PK__country__7E8CD0554D61E8DD");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB8561417899");
        ...
        {
            entity.HasKey(e => e.FilmId).HasName("PK__film__349764A91CA67C31");
        ...
        {
            entity.HasKey(e => new { e.ActorId, e.FilmId }).HasName("PK__film_act__086D31FE82B69BD8");
        ...
        {
            entity.HasKey(e => new { e.FilmId, e.CategoryId }).HasName("PK__film_cat__69C38A32FA4D4BAF");
        ...
        {
            entity.HasKey(e => e.FilmId).HasName("PK__film_tex__349764A921266B23");
        ...
        {
            entity.HasKey(e => e.InventoryId).HasName("PK__inventor__B59ACC49B141B1A1");
        ...
        {
            entity.HasKey(e => e.LanguageId).HasName("PK__language__804CF6B36DB52A06");
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__payment__ED1FC9EA6C59BA80");
        ...
        {
            entity.HasKey(e => e.RentalId).HasName("PK__rental__67DB611B5A065989");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staff__1963DD9CABD100F1");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__store__A2F2A30C811E6996");
